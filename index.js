if (typeof jQuery) {
  ...
  function handleChange() {
    ...
    if (
      ...
      if (
        ...
        ReasonongDataSets = [
          {
            ...
            data: [
              Math.round(
                calculatePer(reasoning_p1.length, getReasoning1.length)
              ),
            ],
            backgroundColor: "#fff",
          },
        ...
        if (reasoning_p2[0] != undefined) {
          ReasonongDataSets.push({
            ...
            data: [
              Math.round(
                calculatePer(reasoning_p2.length, getReasoning1.length)
              ),
            ],
        ...
        if (reasoning_p3[0] != undefined) {
          ReasonongDataSets.push({
            ...
            data: [
              Math.round(
                calculatePer(reasoning_p3.length, getReasoning1.length)
              ),
            ],
        ...
        topColorAssocChartDataSet = [
          {
            ...
            data: [
              Math.round(
                calculatePer(
                  color_association_1.length,
                  getAssociations1.length
                )
              ),
            ],
            backgroundColor: "#fff",
      ...
      // Reasoning 2
      $(".reasoning2_2").text(
        topReasoning2.length <= 0 ? "" : topReasoning2[1]
      );

      // Reasoning 3
      $(".reasoning2_3").text(
        topReasoning2.length <= 0 ? "" : topReasoning2[2]
      );
      ...
      if (reasoning2_p1[0] != undefined) {
        TopReasoningDataSets.push({
          ...
          data: [
            0,
            Math.round(
              calculatePer(reasoning2_p1.length, getReasoning2.length)
            ),
          ],
          backgroundColor: "#fff",
        });
      ...
      if (reasoning2_p2[0] != undefined) {
        TopReasoningDataSets.push({
          ...
          data: [
            0,
            Math.round(
              calculatePer(reasoning2_p2.length, getReasoning2.length)
            ),
          ],
          backgroundColor: "#FBB13C",
        });
      ...
      if (reasoning2_p3[0] != undefined) {
        TopReasoningDataSets.push({
          ...
          data: [
            0,
            Math.round(
              calculatePer(reasoning2_p3.length, getReasoning2.length)
            ),
          ],
          backgroundColor: "#3DA5D9",
        });
